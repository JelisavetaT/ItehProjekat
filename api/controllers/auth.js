...
export const registerMail = async (req, res) => {
  ...
  let email = {
    body: {
      name: username || 'Booking.com',
      intro:
        text ||
        'Welcome to Booking.com! We are very excited to have you on board.',
      outro:
...
// POST /api/auth/reservationMail
export const reservationMail = async (req, res) => {
  const { username, userEmail, text, subject } = req.body;
  ...
  let email = {
    body: {
      name: username || 'Booking.com',
      intro: text || 'You reserved your stay with Booking.com!',
      outro:
        'Need help? Just reply to this email and we will come back to you as soon as possible!',
    },
  };
